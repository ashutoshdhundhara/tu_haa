...
$html_output = '<div class="help_content gray_grad box">'
    ...
    . '<a href="#" class="blue" rel="#simple_overlay" data-file="snapshot_unique_ID.png">Unique ID</a>. Keep it'
    . ' safe. The ID will also be emailed to you.</li>'
    . '<li>If you choose to take a room <strong>Individually</strong> '
    . 'then you have to choose a password and you can use the above ' 
    . '<a href="#" class="blue" rel="#simple_overlay" data-file="snapshot_loginID_individual.png">Unique ID</a>'
    . ' as your Login ID to take rooms.</li>'
    . '</ul>'
